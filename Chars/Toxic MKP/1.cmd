...
type = Changestate
value = 1600
triggerall = (numhelper(7003)=0)&&(numhelper(13002)=0)&&(statetype=S)&&ctrl && (roundstate = 2)
trigger1 = (command = "sp7")&&(command != "run")&&(var(50)=0)
...
trigger1 = (command = "sp9")&&(command != "run")&&(var(50)=0)
trigger1 = ctrl = 1
trigger2 = (var(50)=1)&&(p2stateno!=[1000,1999])&&(p2stateno!=9010)&&(p2stateno!=131);;;;[120,151])
trigger2 = ((p2statetype=C)&&(p2bodydist X<200)&&(p2bodydist X>150))||((p2bodydist X<180)&&(random%10=1))
...
;-------------------------------------------------------;
; - Primer HIT de Combo de Patadas - ;
;-------------------------------------------------------;
[State -1, 2]
type = ChangeState
value = 2101
