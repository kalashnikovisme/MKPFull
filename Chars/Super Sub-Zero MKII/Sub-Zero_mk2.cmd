...
trigger4 = var (50) = 1
trigger4 = p2stateno = 1301
trigger5 = p2stateno = 245
trigger5 = p2BodyDist X < 80
trigger5 = var (50) = 1

[State -2, poder a zero]
type = varset
V = 46
value = 0
trigger1 = var(46) != 0
...
triggerall = p2name != "shao kahn,"
triggerall = p2name != "montaro"
triggerall = p2name != "reiko"
triggerall = p2name != "sonya mk1"
triggerall = p2stateno = 9010
trigger1 = statetype = S
trigger1 = ctrl = 1
triggerall = command != "run"
