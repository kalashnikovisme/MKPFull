...
triggerall = statetype = S
triggerall = numprojid(997) < 2
trigger1 = ctrl = 1
triggerall = numhelper(7003) = 0
triggerall = command != "run"
triggerall = var(46)%2 = 0
...
type = ChangeState
value = 1900
triggerall = (numprojid(997)<2)&&(p2stateno!=14001)&&(p2stateno!=12001)&&(var(46)<2)&&(numhelper(1301)=0)&&(stateno!=[5000,5999])
triggerall = (roundstate = 2)&&(numhelper(7003)=0)&&(numhelper(7004)=0)
trigger1 = (statetype = S)&&(command != "run")&&(command = "sp7")&&ctrl&& Var(50) = 0
trigger2 = (statetype=A)&&(command = "sp7")&& Var(50) = 0
...
trigger1 = (command = "sp8")&&(command != "run")&&(var(50)=0)
...
value = 8000;spear
triggerall = p2stateno != 9010
triggerall = p2stateno != 8021
triggerall = statetype = S
triggerall = ctrl = 1
triggerall = p2stateno != [8020,8040]
trigger1 = command != "run"
...
[State -2];para no hacer dos teleport punch en el aire
type = varset
trigger1 = var(46) != 0
trigger1 = statetype = S
V = 46
...
value = 2000
triggerall = (p2stateno!=12001)&&(numhelper(7003)=0)&&(numhelper(1301)=0)&&(statetype=S)&&ctrl && (roundstate = 2)
trigger1 = (command = "sp11")&&(command != "run")&&(var(50)=0)
trigger1 = ctrl = 1
trigger2 = (var(50)=1)&&(p2stateno!=[1000,1999])&&(p2stateno!=9010)&&(p2stateno!=131);;;;[120,151])
trigger2 = ((p2statetype=C)&&(p2bodydist X<90)&&(p2bodydist X>50))||((p2bodydist X<70)&&(random%10=1))
...
value = 2010
triggerall = (p2stateno!=12001)&&(numhelper(7003)=0)&&(numhelper(1301)=0)&&(statetype=S)&&ctrl && (roundstate = 2)
trigger1 = (command = "sp12")&&(command != "run")&&(var(50)=0)
trigger1 = ctrl = 1
trigger2 = (var(50)=1)&&(p2stateno!=[1000,1999])&&(p2stateno!=9010)&&(p2stateno!=131);;;;[120,151])
trigger2 = ((p2statetype=C)&&(p2bodydist X<90)&&(p2bodydist X>50))||((p2bodydist X<70)&&(random%10=1))
...
value = 7300
triggerall = var(54) = 0
triggerall = command = "Cfriendship"
triggerall = p2stateno = 9010
trigger1 = statetype = S
trigger1 = ctrl = 1
triggerall = command != "run"
...
value = 7310
triggerall = var(54) = 0
triggerall = command = "Sfriendship"
triggerall = p2stateno = 9010
trigger1 = statetype = S
trigger1 = ctrl = 1
triggerall = command != "run"
